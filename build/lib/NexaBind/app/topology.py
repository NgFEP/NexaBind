...
from NexaBind.unit import nanometers, sqrt, is_quantity
...
class Topology(object):
    #Note24: Topology: Represents the topological information about a molecular system. 
    #It comprises chains, residues, atoms, and bonds. It provides methods to add chains, 
    #residues, atoms, and bonds to the topology, retrieve information about these elements, 
    #and manage periodic box vectors for periodic structures.
